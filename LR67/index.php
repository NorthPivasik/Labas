<?php
    require_once ($_SERVER['DOCUMENT_ROOT'] . "/LR67/logic.php");
...
<body>
    ...
    <div id="change" style="position: fixed; bottom: 0; background: lightgray;" class="w-100 d-none">
        <form id="form2" class="container" method="POST" enctype="multipart/form-data">
            <h2>Изменить велосипед</h2>
            <div class="row mt-2">
                <div class="col">
                    <input name="img" type="file">
                </div>
                <div class="col">
                    <input id="change_name" name="name" type="text" class="form-control w-100" placeholder="Название велосипеда">
                </div>
                <div class="col">
                ...
                <div class="col">
                    <input id="change_desc" name="description" type="text" class="form-control w-100" placeholder="Описание велосипеда">
                </div>
                <div class="col">
    ...
    <div class="container">
        <h1 class="mt-5">Список велосипедов</h1>
    </div>
        ...
        <tbody>
            <?php 
                ...
                foreach($data as $row) {
                    ...
                    echo "<td width='200' id='td$r_id 1'><img width='200' src='img/" . $row['img_path'] . "'></td>";
                    echo "<td  id='td$r_id 2'>" . $row['bikename'] . "</td>";
                    echo ("<td width='100' id='td$r_id 3' value='" . convert_select($row['typename']) . "'>" . $row['typename'] . "</td>");
                    echo "<td id='td$r_id 4'>" . $row['bikedescription'] . "</td>";
                    echo "<td width='100' id='td$r_id 5'>" . $row['cost'] . "</td>";
            ?>
    ...
    <form id="form" class="mt-5 mb-5 d-none container" method="POST" enctype="multipart/form-data">
        ...
        <div class="col">
            ...
            <div class="col">
                <input name="name" type="text" class="form-control w-100" placeholder="Название велосипеда">
            </div>
            <div class="col">
            ...
            <div class="col">
                <input name="description" type="text" class="form-control w-100" placeholder="Описание велосипеда">
            </div>
            <div class="col">
